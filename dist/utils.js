...
export function getOauthCredsPath() {
...
export function getProfileCredsPath(profile) {
    return path.join(getProfileDir(profile), OAUTH_CREDS_FILE);
}
export function getCurrentProfilePath() {
...
export async function secureCopyFile(src, dest) {
